...
function AddMemberDialog({ isOpen, setOpen ,fetchData}) {
  ...
  <div className="space-y-4">
    <div>
      <label htmlFor="building" className="text-sm text-blue-gray-500">Building</label>
      <Input
        type="text"
        id="building"
    ...
    <div>
      <label htmlFor="roomNo" className="text-sm text-blue-gray-500">Room No</label>
      <Input
        type="text"
        id="roomNo"
    ...
    <div>
      <label htmlFor="capacity" className="text-sm text-blue-gray-500">Capacity</label>
      <Input
        type="text"
        id="capacity"
        ...
        <CardHeader  floated={false}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              <AddMemberDialog isOpen={isDialogOpen} setOpen={setDialogOpen} fetchData={fetchData} />
              <Button
